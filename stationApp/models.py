...
class Sensors(models.Model):
    ...
    sensorNumber = models.IntegerField(max_length=5)  
    location = models.CharField(max_length=20)
    state = models.CharField(max_length=15)
    value = models.DecimalField(max_digits=4)
...
class Actuators(models.Model):
    ...
    actuatorNumber = models.IntegerField(max_length=5)
    location = models.CharField(max_length=20)
    state =  models.CharField(max_length=15)
    value = models.DecimalField(max_digits=4)
    #crops = models.OneToOneField(Crops,on_delete=models.CASCADE)
...
class Crops(models.Model):
    ...
    CropNumber = models.IntegerField(max_length=5)
    location = models.CharField(max_length=20)
